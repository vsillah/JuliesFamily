...
- **Social Media Feed**: Carousel-based display of curated social media posts supporting both Instagram and Facebook platforms. Features responsive layout (1/2/3 posts per viewport), platform badges on each post, icon-only social links with "Follow us on socials" label, self-contained data fetching, graceful handling of posts without images, and full Content Manager integration for visibility controls, platform selection, and content editing.
