...
export const KINFLO_GENERATED_API_BINDINGS: KinfloGeneratedApiBinding[] = [
  ...
  binding("siteFactoryListClientWebsiteLaunchComposer", "query", "site factory", "siteFactory.listClientWebsiteLaunchComposer client website launch composer includes tenant, template, admin preset, approval evidence, execution steps, blocked live switches, and provider boundaries"),
  ...
  binding("siteFactoryListClientWebsitePreviewReviewPackets", "query", "site factory", "client preview review packets include review URL context, evidence checklist, client-share gates, and provider boundaries"),
  ...
  binding("siteFactoryListClientWebsiteConfigurationApprovalMatrices", "query", "site factory", "client website configuration approval matrices include approver roles, evidence, save blockers, and provider boundaries"),
  binding("siteFactoryListClientWebsiteConfigurationAuditTimelines", "query", "site factory", "client website configuration audit timelines include evidence events, actor labels, rollback notes, blocked actions, and provider boundaries"),
  binding("siteFactoryListClientWebsiteConfigurationChangeSets", "query", "site factory", "client website configuration change sets include draft changes, save blockers, approval evidence, and provider boundaries"),
  binding("siteFactoryListClientWebsiteConfigurationProfiles", "query", "site factory", "client website configuration profiles include template, brand, navigation, CRM, editable surfaces, locked surfaces, and provider boundaries"),
  binding("siteFactoryListClientWebsiteConfigurationPublishReadiness", "query", "site factory", "client website configuration publish readiness includes publish criteria, blockers, rollback requirements, blocked actions, and provider boundaries"),
  binding("siteFactoryListClientWebsiteConfigurationRollbackCheckpoints", "query", "site factory", "client website configuration rollback checkpoints include fixture baselines, rollback owners, rehearsal steps, blocked actions, and provider boundaries"),
  binding("siteFactoryListClientWebsiteConfigurationReviewPackets", "query", "site factory", "client website configuration review packets include selected-site surfaces, save blockers, required evidence, and provider boundaries"),
  binding("siteFactoryListClientWebsiteConfigurationSaveRequests", "query", "site factory", "client website configuration save requests include selected payloads, approval evidence, blockers, rollback posture, and provider boundaries"),
  binding("siteFactoryListClientWebsiteDomainReadinessPackets", "query", "site factory", "client website domain readiness packets include hostname posture, DNS checklist, SSL posture, provider state, rollback plan, and provider boundaries"),
  binding("siteFactoryListClientWebsiteAdminInvitationReadinessPackets", "query", "site factory", "client website admin invitation readiness packets include invite role, scope, evidence, copy blocks, rollback plan, and provider boundaries"),
  binding("siteFactoryListClientWebsiteExperienceConfigurationPresets", "query", "site factory", "client website experience configuration presets include audience, journey, layout density, tone, navigation mode, admin preset, personalization rules, and provider boundaries"),
  ...
  binding("siteFactoryListClientWebsiteVisualQaBudgets", "query", "site factory", "client visual QA budgets include responsive screenshots, accessibility checks, performance budgets, regression targets, and provider boundaries"),
  binding("siteFactoryListClientWebsiteVisualQaEvidencePackets", "query", "site factory", "client visual QA evidence packets include artifact slots, approval checklist, open risks, and provider boundaries"),
