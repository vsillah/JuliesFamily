...
- the admin shell still exposes the operating surfaces for data mode, live adapter readiness, site factory launch packets, site creation wizard, launch readiness review, plans and entitlements, CRM lead workspace, public intake, experience preferences, access delegation, content draft editing, brand theme configuration, navigation builder configuration, preview QA configuration, asset library configuration, domain readiness configuration, integration readiness configuration, campaign automation configuration, and AI review provenance configuration.
...
No browser, provider API, payment, email, SMS, storage, DNS, AI, AI review action, launch execution, generated content publish, campaign automation, analytics, or production data write is performed.
