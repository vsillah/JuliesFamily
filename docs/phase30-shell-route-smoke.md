...
No browser, provider API, payment, email, SMS, storage, DNS, AI, AI review action, generated content publish, campaign automation, analytics, or production data write is performed.
