...
- the admin shell still exposes the operating surfaces for data mode, live adapter readiness, site factory launch packets, site creation wizard, plans and entitlements, CRM lead workspace, and public intake.
