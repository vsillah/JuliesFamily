...
- tighten fixture-to-live parity, adapter-switch evidence, the Phase 87 switch runway, and the Phase 88 generated API review board through `docs/convex-adapter-switch-evidence-matrix.json`,
