...
- tighten fixture-to-live parity, adapter-switch evidence, the Phase 87 switch runway, the Phase 88 generated API review board, and the Phase 89 adapter switch acceptance matrix through `docs/convex-adapter-switch-evidence-matrix.json`,
