...
- `preview-deployment`: blocked on Vercel build-rate limit for PR #1 head `164629f`; do not treat the preview as integration-ready until Vercel recovers and `npm run kinflo:validate-pr-review-state` passes again.
...
- Vercel build-rate limit recovery and PR preview deployment state confirmation.
