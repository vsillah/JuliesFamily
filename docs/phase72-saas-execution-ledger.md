...
- tighten fixture-to-live parity, adapter-switch evidence, the Phase 87 switch runway, the Phase 88 generated API review board, the Phase 89 adapter switch acceptance matrix, and the Phase 90 hosted smoke gap backlog through `docs/convex-adapter-switch-evidence-matrix.json`,
