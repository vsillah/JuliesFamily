...
const compactMarkers = [
  ...
  "max-h-[360px]",
  "overflow-y-auto overflow-x-hidden md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]",
...
requireIncludes("docs/phase86-site-studio-scroll-consolidation.md", [
  ...
  "230px local list caps",
  "one full-width dossier until the rail is wide enough",
