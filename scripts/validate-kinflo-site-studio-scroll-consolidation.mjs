...
const compactMarkers = [
  ...
  "activeTab === \"site-studio\" ? \"mb-1 rounded-md px-2 py-1.5\"",
  ...
  "hidden grid-cols-2 gap-2 rounded-lg border border-slate-200 bg-white p-2 shadow-sm lg:grid lg:grid-cols-4",
  ...
  "hidden min-h-0 min-w-0 max-h-[calc(100vh-18rem)]",
  ...
  "max-h-[min(340px,calc(100vh-21rem))]",
  "grid-cols-4",
